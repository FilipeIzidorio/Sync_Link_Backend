...
/**
 * Entidade que representa o usuário do sistema Sync Link.
...
public class Usuario implements UserDetails {
    ...
    // 🔹 Construtor adicional (útil no AuthController e testes)
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        // Prefixo ROLE_ é obrigatório para reconhecimento pelo Spring Security
